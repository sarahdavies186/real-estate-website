export default function Contact() {
  return (
    <section id="contact" className="bg-white dark:bg-gray-900 container font-poppins-regular pb-20">
      <div className="py-10 px-10 mx-auto max-w-screen-md">
        <h2 className="mb-4 text-4xl tracking-tight font-rubik-semibold text-center text-gray-900">
          Contact Us
        </h2>
        ...
        <form action="#" className="space-y-8">
          ...
          <div>
            ...
            <input
              type="text"
              id="subject"
              className="block p-3 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 d-primary-500"
